...
export type UserWorkRecordUpdateResponse = {
	id: string;
	taskID: string;
	startedAt: string;
...
export const userWorkRecordUpdateResponse = (workRecord: WorkRecordWithTask): UserWorkRecordUpdateResponse => ({
	id: workRecord.id,
	...
	task: {
		...
		project: { id: workRecord.task.project.id, name: workRecord.task.project.name },
	},
});
